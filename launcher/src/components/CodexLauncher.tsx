import { type CSSProperties, Suspense, lazy, useEffect, useMemo, useRef, useState } from "react";
...
// Share/Create is unbound elsewhere in this app. Bit assumed at buf[9] 0x10 per the
// standard DualSense shoulders-byte layout (L1=0x01,R1=0x02,L2=0x04,R2=0x08,Create=0x10,
// Options=0x20,L3=0x40,R3=0x80) — matches hid.rs's confirmed Options=0x20, but this bit
// itself is NOT independently verified on hardware yet (see hid.rs's verification notes).
