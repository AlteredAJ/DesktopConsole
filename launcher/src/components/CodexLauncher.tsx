...
.codex-power-action{display:flex;align-items:center;gap:0;padding:12px 16px;border-radius:14px;cursor:pointer;border:1px solid transparent;background:none;color:inherit;font:inherit;text-align:left;transition:background .15s}
.codex-power-action:hover{background:rgba(255,255,255,.04)}
.codex-power-action.selected{background:linear-gradient(105deg,color-mix(in srgb,var(--focus-bloom) 30%,rgba(255,255,255,.12)),rgba(255,255,255,.08));border-color:color-mix(in srgb,var(--focus-bloom) 18%,transparent);box-shadow:0 0 18px color-mix(in srgb,var(--focus-bloom) 18%,transparent),inset 0 1px rgba(255,255,255,.25)}
...
.codex-power-action-glyph{font-size:1.4cqh;opacity:.35;font-weight:600;display:flex;align-items:center}
