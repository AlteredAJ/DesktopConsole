import { BrandHero } from "./shared";

// Generic "Browser" tile — the Chrome mark itself is the main subject here
// (not just a corner badge) since this tile IS "open Chrome", unlike the
// streaming tiles where Chrome is incidental to what you're actually going to.
  ...
  return (
    <BrandHero
      ...
      path={[
        ...
        "M12 16.364a4.364 4.364 0 1 1 0-8.728 4.364 4.364 0 0 1 0 8.728Z",
      ]}
    />
  );
}
